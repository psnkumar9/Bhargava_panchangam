...
def nakshathra_dhasa_progression(
    ...
    vd = get_dhasa_bhukthi(dob,tob, place, star_position_from_moon=star_position_from_moon,
                    ...
                    chart_method=chart_method,seed_star=seed_star,dhasa_starting_planet=dhasa_starting_planet,
...
def shodasottari_immediate_children(
    ...
    *,
    jd_at_dob,
    place,
    # Accepted for API parity; the tiler itself does not use them:
    star_position_from_moon=1,
    use_tribhagi_variation=False,
    divisional_chart_factor=1,
    chart_method=1,
...
def get_running_dhasa_for_given_date(
    ...
    **kwargs
    ...
    def _to_utils_periods(children_rows, parent_end_tuple, eps_seconds=1.0):
        ...
        proj.append((proj[-1][0], parent_end_tuple))  # sentinel for last boundary
        return proj
