...
def sataatbika_immediate_children(
    ...
    **kwargs
    ...
    # Use the same year basis as module code (alias of const.sidereal_year)
...
def get_running_dhasa_for_given_date(
    ...
    *,
    # REQUIRED knob (explicit):
    antardhasa_option: int = 1,
    # Forwarded to base Sataatbika get_dhasa_bhukthi:
    star_position_from_moon=1,
    use_tribhagi_variation=False,
    divisional_chart_factor=1,
    chart_method=1,
    seed_star=27,
    dhasa_starting_planet=1,
    round_duration=False,        # runner uses exact starts/ends
    **kwargs
):
    """
    ...
    maha_rows = get_dhasa_bhukthi(
        ...
        round_duration=False,  # runner needs exact tiling
    )
